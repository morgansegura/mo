                        ...
                        <HeroSplit.Body className="py-12 px-10 lg:px-16 lg:py-18">
                            ...
                            <HeroSplit.TextContainer className="font-sans text-base leading-loose">
                                <HeroSplit.Text className="mb-3 pt-2">
                                    ...
                                    duchovny end of the road gatorade, cornrows
                                    pulp fiction alta vista skate tees roseanne
                                    barr wesley snipes. Eminem bandanas fanny
                                    packs hot pink boy bands when you’re lost
                                    out there and you’re all alone.
                                </HeroSplit.Text>
                                <HeroSplit.Text className="pt-2">
                                    Flip flops wearing your cap backwards
                                    encarta I've fallen and I can't get up wayne
                                    gretzky tamagotchi. Nintendo 64 sup hip hop
                                    playa puff daddy, courtney love end of the
                                    road warheads push pencils.
                                </HeroSplit.Text>
                ...
                <Containers.Child>
                    <BlockNote className="relative flex flex-col py-16 px-10 lg:py-20 lg:px-16">
                        ...
                        <BlockNote.Text className="self-end text-right w-2/3">
                            Export Sketch, Figma, and Adobe XD to HTML or React.
                            Get clean, responsive code components tailored to
                            your team’s conventions, with zero dependencies and
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-4 gap-y-6">
                    <div className="relative mb-20 max-w-lg mr-auto">
                        <div className="card p-4 font-sans text-sm flex rounded-md shadow-lg">
                            <p>
                                Dallas cowboys roseanne barr keds game boy
                                color. Once you pop you can’t stop pearl jam
                                flip flops tommy hilfiger chillax renting movies
                                at a store, acid wash the simpsons push pencils
                                nirvana. Pop punk dawg destiny’s child dial-up
                                minesweeper cut-off jean shorts. Visor
                                blockbuster video skidz and zubas your mom.
                            </p>
                        </div>
                        <img
                    ...
                    <div className="relative mb-20 max-w-lg ml-auto">
                        <div className="card font-sans p-4 text-sm flex rounded-md shadow-lg">
                            <p>
                                ...
                                scrunchies, toy story dennis rodman big lebowski
                                kicks. Generation Y skifree push pencils
                                alternative rock, goosebumps baywatch madonna
                                desert storm magic johnson. Tupac shakur
                                warheads sup gak, kazaa velcro sneakers berry
                                lips steve urkel. Hush puppies pizza bagels
                                apollo 13 julia roberts g-shocks keepin’ it
                                real.
                            </p>
                        </div>
                        <img
                ...
                <div>
                    <div className="relative mb-32 md:mb-20 mt-6 max-w-lg mr-auto xl:mx-auto">
                        <div className="xl:ml-20 card font-sans p-4 text-sm flex rounded-md shadow-lg">
                            <p>
                                Ghost pottery scene alternative rock wesley
                                snipes push pencils, beavis and butthead the
                                macarena I don’t want no scrubs forrest gump.
                                Playstation tommy hilfiger my heart will go on
                                acid wash fly bomber jacket. Sitcoms trl
                                roseanne barr leggings, overalls quiet storm bop
                                it west wing tae bo. Geo metro ring pops
                                internet cable modem dotcom bubble, members only
                                jackets i'm king of the world millenials daria
                                desert storm.
                            </p>
                        </div>
                        <img
                            className="avatar -mt-2 lg:-ml-8 w-20 h-20 xl:ml-6 rounded-full absolute"
                            src="https://images.generated.photos/qmdENySIv23bkva-PxTHsoxVbZQdB1Wka0ZPcH5shHY/rs:fit:512:512/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yy/XzAzMDE4MzAuanBn.jpg"
                            alt="Jose Jimenez"
                        />
